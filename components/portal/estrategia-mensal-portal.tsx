...
// Versão somente leitura da estratégia mensal, exibida no portal do cliente.
// Mesma visão que a equipe tem — sem opções de edição.
export function EstrategiaMensalPortal({ estrategias }: { estrategias: EstrategiaMensal[] }) {
  ...
  return (
    <div className="grid gap-4">
      ...
      {atual && (
        <div className="grid gap-4 rounded-2xl border border-border bg-card p-5 sm:p-6">
